...
var Config = import_koishi.Schema.intersect([
  import_koishi.Schema.object({
    ...
    pageSize: import_koishi.Schema.number().min(1).max(40).default(10).description("每页展示的结果数量，范围1-40。")
  }).description("基础设置"),
  import_koishi.Schema.object({
      ...
      return `
        <div class="work-item">
          ...
          <div class="info">
            ...
            <div class="details">
              <span><i class="icon">社团：🏢</i>${import_koishi.h.escape(work.name)}</span>
...
可附加 card | file | zip 选项，例如 "1 2 3 card"`);
  ...
  function buildEntryText(work, index, page) {
    ...
    return [
      ...
      `   标题: ${import_koishi.h.escape(work.title)}`,
      `   社团: 🏢 ${import_koishi.h.escape(work.name)}`,
      `   日期: 📅 ${work.release}`,
